...
_PROMPTS: list[dict[str, str]] = [
    {
        ...
        "intent": "Assess an aging codebase and identify high-value applicable kits.",
        "prompt_template": (
            "Analyze this legacy project and infer traits from the repository. "
            "Use the instruction MCP to select candidate kits, broaden if needed, "
    ...
    },
    {
        ...
        "prompt_template": (
            "Given this project context, infer stack traits and produce a recommended "
    ...
    },
    {
        ...
        "intent": "Add a new capability while preserving compatibility with current stack.",
        "prompt_template": (
            "Identify what is missing for the target capability, select relevant kits, "
            "flag conflicts with existing traits, and propose an implementation plan."
        ),
    },
    {
        "name": "tech_debt_modernization",
        "title": "Tech Debt Modernization Priority",
        "intent": "Prioritize modernization work with kit-guided adoption steps.",
        "prompt_template": (
            "Assess technical debt hotspots, map them to applicable kits, and rank "
